...
@Component({
  selector: 'app-termination-history',
  templateUrl: './termination-history.component.html',
  styleUrls: ['./termination-history.component.css']
})
export class TerminationHistoryComponent implements OnInit {
